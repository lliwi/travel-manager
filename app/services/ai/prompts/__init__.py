...
EXTRACT_DOCUMENT = _BASE + (
    ...
    'IMPORTANTE: un documento describe con frecuencia VARIOS servicios, y '
    'debes devolver uno por cada uno en la lista «servicios»:\n'
    '- Un billete de ida y vuelta son DOS vuelos: uno de ida y otro de vuelta. '
    'Devuelve los dos, cada uno con su número, su ruta y sus horarios.\n'
    '- Una reserva de hotel puede cubrir varias habitaciones o varias estancias '
    'con fechas distintas.\n'
    '- Un trayecto con escala son varios tramos consecutivos.\n'
    'No resumas varios servicios en uno solo ni te quedes con el primero: cada '
    'uno tiene sus propios horarios y su propia ruta, y perder uno deja el '
    'itinerario incompleto.\n\n'
    'Una reserva puede cubrir además a VARIAS PERSONAS. Los asientos suelen '
    'venir en una tabla con una columna por trayecto: «Seat 15D | 15D» significa '
    'que esa persona ocupa el 15D en el primero y el 15D en el segundo. Devuelve '
    'la lista «pasajeros» de cada servicio con el asiento que corresponde a ESE '
    'trayecto, no el del otro. Si la reserva es de una sola persona puedes usar '
    'además «pasajero» y «asiento».\n\n'
